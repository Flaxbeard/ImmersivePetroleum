...
public class BlockIPSlab<E extends Enum<E>&BlockIPBase.IBlockEnum> extends BlockIPTileProvider<E>
{
	public static final PropertyInteger prop_SlabType = PropertyInteger.create("slabtype", 0,2);

	public BlockIPSlab(String name, Material material, PropertyEnum<E> property)
	{
		super(name, material, property, ItemBlockIPSlabs.class, prop_SlabType);
