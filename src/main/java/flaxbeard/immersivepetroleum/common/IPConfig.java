...
public class IPConfig
{
	...
	public static class Extraction{
		...
		public final ConfigValue<Float> reservoir_chance;
		...
		Extraction(ForgeConfigSpec.Builder builder){
			...
			reservoir_chance=builder.define("reservoir_chance", Float.valueOf(0.5F));
	...
	public static class Refining{
		public final ConfigValue<Float> distillationTower_energyModifier;
		public final ConfigValue<Float> distillationTower_timeModifier;
		...
		Refining(ForgeConfigSpec.Builder builder){
			...
			distillationTower_energyModifier=builder.define("distillationTower_energyModifier", Float.valueOf(1.0F));
			
			builder.comment("A modifier to apply to the time of every Distillation recipe. Can't be lower than 1, default=1");
			distillationTower_timeModifier=builder.define("distillationTower_timeModifier", Float.valueOf(1.0F));
	...
	@Deprecated
	public static class IPConfig_OLD
	{
		//@Comment({"Display chunk border while holding Core Samples, default=true"})
		@Deprecated
		public static boolean sample_displayBorder = true; // Was moved to the Miscellaneous class!
