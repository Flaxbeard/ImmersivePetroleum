...
public class ModelLubricantPipes
{
	...
	public static class Base extends ModelBase
	{
		...
		{	
			...
			tankSide1.addBox(3, 14, 3, 10, 17, 0);
			base.addChild(tankSide1);
			
			ModelRenderer tankSide2 = new ModelRenderer(this, 32, 46);
			tankSide2.addBox(3, 14, 13, 10, 17, 0);
			base.addChild(tankSide2);
			
			ModelRenderer tankSide3 = new ModelRenderer(this, 32, 46 - 10);
			tankSide3.addBox(3, 14, 3, 0, 17, 10);
			base.addChild(tankSide3);
			
			ModelRenderer tankSide4 = new ModelRenderer(this, 32, 46 - 10);
			tankSide4.addBox(13, 14, 3, 0, 17, 10);
