...
public class EntitySpeedboat extends EntityBoat
{
	...
	private static final DataParameter<ItemStack> UPGRADE_0 = EntityDataManager.createKey(EntitySpeedboat.class, DataSerializers.OPTIONAL_ITEM_STACK);
	private static final DataParameter<ItemStack> UPGRADE_1 = EntityDataManager.createKey(EntitySpeedboat.class, DataSerializers.OPTIONAL_ITEM_STACK);
	private static final DataParameter<ItemStack> UPGRADE_2 = EntityDataManager.createKey(EntitySpeedboat.class, DataSerializers.OPTIONAL_ITEM_STACK);
	private static final DataParameter<ItemStack> UPGRADE_3 = EntityDataManager.createKey(EntitySpeedboat.class, DataSerializers.OPTIONAL_ITEM_STACK);
