...
public class ManualPageSchematicCrafting extends ManualPages.Crafting
{
	public ManualPageSchematicCrafting(ManualInstance manual, String text, Object stack)
	{
		...
		ItemStack schematic = new ItemStack(IPContent.itemSchematic);
		...
		pIngredients[1] = new PositionedItemStack(new ItemStack(Items.PAPER, 1, 0), xBase + 18, 0);
		pIngredients[9] = new PositionedItemStack(schematic, xBase+3*18+18, (int)(3/2f*18)-8);
		recipes.put(stack, pIngredients);
		
		PositionedItemStack[] pIngredients2 = new PositionedItemStack[10];
		for(int hh = 0; hh < 3; hh++)
			for(int ww = 0; ww < 3; ww++)
					pIngredients2[hh * 3 + ww] = new PositionedItemStack(null, xBase + ww * 18, hh * 18);
		pIngredients2[0] = new PositionedItemStack(schematic, xBase, 0);
		pIngredients2[1] = new PositionedItemStack(new ItemStack(Items.PAPER, 1, 0), xBase + 18, 0);
		pIngredients2[9] = new PositionedItemStack(schematic, xBase+3*18+18, (int)(3/2f*18)-8);
		recipes.put(stack, pIngredients2);
