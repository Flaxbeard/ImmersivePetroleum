package flaxbeard.immersivepetroleum.dummy;

/**
 * This class needs to be removed once porting is complete! Its only purpose is
 * to reach a compiling/launching state earlier (and thereby allow rendering
 * changes to be tested), by providing stubs for all methods in GlStateManager
 * used by IP
 */
@Deprecated
