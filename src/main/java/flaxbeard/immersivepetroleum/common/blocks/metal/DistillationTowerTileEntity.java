...
public class DistillationTowerTileEntity extends PoweredMultiblockTileEntity<DistillationTowerTileEntity, DistillationRecipe> implements IAdvancedSelectionBounds, IAdvancedCollisionBounds, IInteractionObjectIE{
	public static TileEntityType<DistillationTowerTileEntity> TYPE;
	
	public static class TileEntityDistillationTowerParent extends DistillationTowerTileEntity{
		@Override
		@OnlyIn(Dist.CLIENT)
	...
	public void readCustomNBT(CompoundNBT nbt, boolean descPacket){
		...
		// TODO Not sure if this kind of stuff is even needed anymore.
	...
	protected IFluidTank[] getAccessibleFluidTanks(Direction side){
		DistillationTowerTileEntity master = this.master();
		int pos = 0; // FIXME Temporary Fix
		if(master != null){
	...
	@Override
	public DistillationTowerTileEntity getTileForPos(BlockPos targetPosInMB){
